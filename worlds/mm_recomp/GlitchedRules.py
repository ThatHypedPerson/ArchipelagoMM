...
def get_glitched_region_rules(player, options):
    return {
        "Clock Town -> Index Warp":
            lambda state: glitch_enabled("Index Warp", options) and state.has("Progressive Bow", player),
...
def get_glitched_location_rules(player, options):
    return {
        ...
        "Powder Keg Goron Reward":
            lambda state: state.has("Goron Mask", player) and (can_clear_snowhead(state, player) or can_use_fire_arrows(state, player) or glitch_enabled("Action Swap", options) or trick_enabled("Melt Ice as Fierce Deity", options)),
        ...
        "Goron Village Deku Trade Freestanding HP (Spring)":
            lambda state: can_clear_snowhead(state, player) and state.can_reach("Goron Village Deku Trade Freestanding HP", 'Location', player),
        ...
        "Pinnacle Rock Upper Eel Chest":
            lambda state: state.has("Zora Mask", player) and ((can_reach_seahorse(state, player) and has_bottle(state, player)) or trick_enabled("Pinnacle Rock without Seahorse", options)),
        ...
        "Stone Tower Temple Eastern Water Room Underwater Chest":
            lambda state: state.has("Small Key (Stone Tower)", player) and state.has("Zora Mask", player) and (can_use_light_arrows(state, player) or has_mirror_shield(state, player)) or (glitch_enabled("Stone Tower Clip Through Sun Block as Zora", options) and trick_enabled("Stone Tower Hit Underwater Sun Switch with Ice Arrows", options)) or can_use_ice_arrows(state, player) and trick_enabled("Stone Tower Hit Underwater Sun Switch with Ice Arrows", options) and can_use_light_arrows(state, player),
        ...
        "Stone Tower Temple Inverted Eastern Air Gust Room Ice Eye Switch Chest":
            lambda state: can_use_light_arrows(state, player) and state.has("Deku Mask", player) and can_use_fire_arrows(state, player) or (can_use_light_arrows(state, player) and (glitch_enabled("Action Swap", options) or can_use_fire_arrows(state, player))),
