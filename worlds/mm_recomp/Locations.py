...
location_data_table: Dict[str, MMRLocationData] = {
    ...
    "Tingle Clock Town Map Purchace": MMRLocationData(
        region="Clock Town",
        address=0x34694200000B4
    ),
    "Tingle Woodfall Map Purchace": MMRLocationData(
        region="Southern Swamp",
        address=0x34694200000B5
    ),
    "Tingle Snowhead Map Purchace": MMRLocationData(
        region="Twin Islands",
        address=0x34694200000B6
    ),
    "Tingle Romani Ranch Map Purchace": MMRLocationData(
        region="Milk Road",
        address=0x34694200000B7
    ),
    "Tingle Great Bay Map Purchace": MMRLocationData(
        region="Great Bay",
        address=0x34694200000B8
    ),
    "Tingle Stone Tower Map Purchace": MMRLocationData(
        region="Ikana Canyon",
